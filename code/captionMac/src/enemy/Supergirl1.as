...
package enemy
{
	...
	public class Supergirl1 extends Enemy
	{
		
		[Embed(source = '../img/boss/supergirl1.png')] public   var supergirl1png:Class;
		...
		public function Supergirl1(X:Number,Y:Number,Type:int)
		{
			x=X
			y=Y	
			health=200
			...
			starty=y	
			if(type==0){	
				this.loadGraphic(supergirl1png,true,true,150,150,false)
				...
				this.addAnimation(Actions.WALK,[20,19,18,17,16],10,true)
				
				this.addAnimation(Actions.DAMAGE_CATCH,[7,6,5,4],10,false)
				this.addAnimation(Actions.DAMAGE_NORMAL,[7,6,5,4],8,false)
				...
				this.addAnimation(Actions.DROPDOWN_FACE,[15,14,13,12,11,10,9,21,22,23],8,false)	
				...
				this.addAnimation(Actions.ATTACK_NORMAL,[0,2,1,0],10,false)		
...
//				{
					...
					if(dd==0){
					f1.setBody1(superdead1png,true,6,[0,1,2,3,4,5],120,150)
