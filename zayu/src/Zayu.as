...
package 
{
	...
	public class Zayu extends Sprite
	{
		
		private var _sceneManager:SceneManager;
		
		public function Zayu()
		{
...
class ActorParam extends BaseActor
{
	...
	public function ActorParam(B:Bitmap, C:ColorTransform, charctorSize:int)
	{
		...
		for (I = 0; I < S3; I += SIZE)
		{
			for (J = 0; J < SIZE; ++J)
			{
				_img_r.copyPixels(_img, new Rectangle(I + J, 0, 1, S4), new Point(I + SIZE - J, 0));
			}
		}
		...
		else
		{
			...
			switch (_step)
			{
				...
				case 2: 
				{
					...
					it.addEventListener(Event.COMPLETE, function(e:Event):void
						{
